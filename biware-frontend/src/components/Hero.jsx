    ...
    >
      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: 860 }}>
        ...
        <div style={{
          ...
          Data Management & Analytics · SAS® Partner · Microsoft Gold Partner
        </div>
        ...
        <h1 style={{
          ...
          There is no<br />
          <span style={{ color: 'var(--bw-orange)' }}>Devil</span><br />
          <span style={{ color: 'rgba(255,255,255,0.35)' }}>in your Data</span>
        </h1>
        ...
        <p style={{
          ...
          Biware accompagne les grandes entreprises d'Afrique et d'Europe à créer de la valeur à partir de leur actif DATA — connaissance client, risk management, analytics avancé.
        </p>
