      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.45rem', fontSize: '0.78rem', color: 'rgba(255,255,255,0.3)' }}>
            ...
            <strong style={{ color: 'rgba(255,255,255,0.6)', fontWeight: 500 }}>Rue du Lac Windermere, Résidence ERRAWDHA, 1053 Les Berges du Lac, Tunis – Tunisie</strong>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.45rem', fontSize: '0.78rem', color: 'rgba(255,255,255,0.3)' }}>
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
            ...
            <strong style={{ color: 'rgba(255,255,255,0.6)', fontWeight: 500 }}>+216 29 969 439</strong>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.45rem', fontSize: '0.78rem', color: 'rgba(255,255,255,0.3)' }}>
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
            ...
            <strong style={{ color: 'rgba(255,255,255,0.6)', fontWeight: 500 }}>contact@biware-consulting.com</strong>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.45rem', fontSize: '0.78rem', color: 'rgba(255,255,255,0.3)' }}>
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
            ...
            <strong style={{ color: 'rgba(255,255,255,0.6)', fontWeight: 500 }}>biware-consulting.com</strong>
          </div>
        </div>
      </div>
